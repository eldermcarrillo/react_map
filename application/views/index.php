...
<script type="text/javascript" src="<?php echo base_url('src/build/watchfile.bundle.js')?>"></script>
  ...
  -->
<link rel="stylesheet" type="text/css" href= "http://localhost:8080/react_map/node_modules/react-table/react-table.css">
<script type="text/javascript" src="http://localhost:8080/react_map/src/build/watchfile.bundle.js"></script>
</body>
</html>
